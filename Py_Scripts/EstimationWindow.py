...
class Ui_EstimationWindow(object):
    def setupUi(self, EstimationWindow):
        ...
        self.gridLayout.addItem(spacerItem16, 1, 10, 1, 2)
        spacerItem17 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout.addItem(spacerItem17, 2, 8, 1, 1)
        ...
        self.gridLayout.addItem(spacerItem18, 1, 8, 1, 2)
        self.frame = QtWidgets.QFrame(self.centralwidget)
        self.frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setObjectName("frame")
        self.gridLayout.addWidget(self.frame, 5, 2, 8, 11)
